...
outbox_wd = 'compute'
if not os.path.isdir(outbox_wd):
  os.mkdir(outbox_wd)
...
chipy.overall_SetWorkingDirectory(datbox_wd)
...
chipy.utilities_logMes('READ POSTPRO')
chipy.ReadPostproFile()

chipy.overall_SetWorkingDirectory(outbox_wd)
...
chipy.SetDomainBoundary(Ymin=-1.5)
#
# simulation part ...
#
