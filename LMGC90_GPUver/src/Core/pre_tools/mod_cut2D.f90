...
CONTAINS
   ...
   subroutine get_inner_particles(inner_radii, inner_coor)
      
      implicit none
   
      ! variables de sortie :
      real(kind=8), dimension(nb_grains), intent(out) :: inner_radii !< radii of the remaining particles 
         ! rayons  des particules a l'interieur du contour
      real(kind=8), dimension(2, nb_grains), intent(out) :: inner_coor !< coordinates of the remaining prticles
         ! coordonnees des particules a l'interieur du contour
