...
# removing vertical walls
chipy.RBDY2_SetBodiesInvisible([2,3])
# computing objects belonging to the membrane
chipy.RBDY2_MembraneBiaxialLoading(4,1,2.,0.)
#
# simulation part ...
#
...
for k in range(0,nb_steps):
  ...
  # applying load to the objects belonging to the membrane
  chipy.RBDY2_MembraneBiaxialLoading(4,1,2.,1000000.)
