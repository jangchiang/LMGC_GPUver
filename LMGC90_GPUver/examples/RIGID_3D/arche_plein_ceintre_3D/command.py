...
chipy.OpenDisplayFiles(write_f2f=True, write_ck=True)
...
for k in range(0,nb_steps):
  ...
  ## central kernel from @amrani's internship
  #if k % freq_display == 0:
  #    time   = chipy.TimeEvolution_GetTime()
  #    f2f    = chipy.PRPRx_GetF2f2Inters()
  #    inters = chipy.getInteractions()
  #    idx    = inters['inter'] == 'PRPRx'.encode()
  #    prprx  = inters[idx]
  #    post.WriteCentralKernelFiles(time, f2f, prprx)
