...
if elas: 
  ...
  joint = pre.material(name='Joint', materialType='JOINT_MC',stiffnesses=[1e10,1e10],consolidation=[1e12,1e-2],mc=[RTRAC,PHI,C,ZMU])  
...
# b.imposeDrivenDof(group='up', component=[3], dofty='force',description='evolution',evolutionFile='Fz.dat')
