...
center=numpy.zeros(3, 'd') # [0., 0., 0.] # centre de la sphere
...
deposited_radii=[2.5]
deposited_coor=[0., 0., 0.]

# on cree le corps correpsondant

# creation d'une nouvelle sphere rigide
body = pre.rigidSphere(r=deposited_radii[0], center=deposited_coor, 
...
nb_comp_particles, coor = pre.depositInSphere3D(radii, R, center, deposited_radii=deposited_radii,
                                                deposited_coor=deposited_coor, seed=seed2)
...
# pi/2  
wall.rotate(theta=0.5*math.pi, center=wall.nodes[1].coor)
# blocage du mur
