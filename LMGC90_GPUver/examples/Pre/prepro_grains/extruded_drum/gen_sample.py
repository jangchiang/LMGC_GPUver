...
# ajout du tambour
drum = pre.rigidDisk(r=r, center=[r,r], model=modR2D, material=tdur, color='BLEUx', is_Hollow=True)
...
drum3D.imposeDrivenDof(component=6,dofty='vlocy',ct=math.pi/30.,rampi=1.)
