...
body = pre.rigidDisk(r=deposited_radii[0], center=deposited_coor[0: 2], 
...
body = pre.rigidDisk(r=deposited_radii[1], center=deposited_coor[2: 4], 
                     model=mod, material=glass, color='BLEUx')
# ajout du disque dans le conteneur de corps
bodies += body
...
[nb_remaining_particles, coor] = pre.depositInBox2D(radii, lx, ly,
   deposited_radii=deposited_radii, deposited_coor=deposited_coor)
